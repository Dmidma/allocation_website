  ...
  <div class="container">
    ...
    <div class="botBorder clearFix ">
      <table class="cart">
        ...
        <tbody>
          ...
          <?php
            ...
            {
              echo '<tr>
                  <td><img style="max-width: 150px" src="' . $reservation["circuit_image"] . '"></td>
                    <td><a href="hotels.php?hotel=' . $reservation["circuit_id"] . '">' . $reservation["circuit_nom"] . '</a></td>
                  <td class="numCell">' . $reservation["circuit_prix"] . 'DT</td>
      ...
      <div class="totals">
        ...
        <a href="circuit_cart.php?generate_code=oui"><div class="button add fright">Generer Codes</div></a>
